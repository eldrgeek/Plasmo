...
def server_info() -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"Could not get tools list from FastMCP registry: {e}")
            # FastMCP automatically manages tool registration via @mcp.tool() decorators
            tools_list = ["FastMCP auto-discovery enabled - tools detected via decorators"]
...
# Automation and orchestration tools factored out to automation/ module - no longer core MCP tools

# Removed send_orchestration_command - moved to automation/orchestration.py
# Removed inject_prompt_native - moved to automation/native_automation.py
# Removed focus_and_type_native - moved to automation/native_automation.py
...
# Claude instance management tools factored out to agents/ module - no longer core MCP tools

# Removed launch_claude_instance - moved to agents/claude_instances.py
# Removed list_claude_instances - moved to agents/claude_instances.py  
# Removed send_inter_instance_message - moved to agents/claude_instances.py
# Removed coordinate_claude_instances - moved to agents/claude_instances.py
...
# Service orchestration tools factored out to services/ module - no longer core MCP tools

# Removed service_status - moved to services/orchestrator.py
# Removed start_service - moved to services/orchestrator.py
# Removed stop_service - moved to services/orchestrator.py
# Removed restart_service - moved to services/orchestrator.py
# Removed start_all_services - moved to services/orchestrator.py
# Removed stop_all_services - moved to services/orchestrator.py
# Removed service_logs - moved to services/orchestrator.py
# Removed service_health_check - moved to services/orchestrator.py

# Firebase tools completely factored out to firebase/ module and native tools system
